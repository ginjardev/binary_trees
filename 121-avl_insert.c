...
/**
 * height - Calculates the height of a BT.
							...
							avl_t **new, int value)
{
	...
	bstfactor = balance(*tree);
	if (bstfactor > 1 && (*tree)->left->n > value)
		*tree = binary_tree_rotate_right(*tree);
	else if (bstfactor < -1 && (*tree)->right->n < value)
		*tree = binary_tree_rotate_left(*tree);
	else if (bstfactor > 1 && (*tree)->left->n < value)
	{
